...
public class DeviceControlActivity extends BaseActivity {
    ...
    public void onStart() {
        ...
        final String mode = Utils.getStringPref(this, getString(R.string.pref_commands_mode));
...
//        this.show_timings = Utils.getBooleanPreference(this, getString(R.string.pref_log_timing));
        this.show_timings = Utils.getBooleanPref(this, getString(R.string.pref_log_timing));
//        this.show_direction = Utils.getBooleanPreference(this, getString(R.string.pref_log_direction));
        this.show_direction = Utils.getBooleanPref(this, getString(R.string.pref_log_direction));
//        this.needClean = Utils.getBooleanPreference(this, getString(R.string.pref_need_clean));
        this.needClean = Utils.getBooleanPref(this, getString(R.string.pref_need_clean));
    }
    ...
    protected String getCommandEnding() {
        ...
        String result = Utils.getStringPref(this, getString(R.string.pref_commands_ending));
        switch (result) {
            case "\\r\\n":
                result = "\r\n";
                break;
